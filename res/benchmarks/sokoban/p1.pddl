(define (problem p1-sokoban-non-deterministic)
	...
	(:init
		...
		(move-dir r10c6 r11c6 down)
		(move-dir r10c6 r10c5 left)
		

		;; r11c0 - wall
		(not (is-clear r11c0))
		(move-dir r11c0 r10c0 up)
		(move-dir r11c0 r11c1 right)
		

		;; r11c1 - wall
		(not (is-clear r11c1))
		(move-dir r11c1 r10c1 up)
		(move-dir r11c1 r11c0 left)
		(move-dir r11c1 r11c2 right)
		

		;; r11c2 - wall
		(not (is-clear r11c2))
		(move-dir r11c2 r10c2 up)
		(move-dir r11c2 r11c1 left)
		(move-dir r11c2 r11c3 right)
		

		;; r11c3 - wall
		(not (is-clear r11c3))
		(move-dir r11c3 r10c3 up)
		(move-dir r11c3 r11c2 left)
		(move-dir r11c3 r11c4 right)
		

		;; r11c4 - wall
		(not (is-clear r11c4))
		(move-dir r11c4 r10c4 up)
		(move-dir r11c4 r11c3 left)
		(move-dir r11c4 r11c5 right)
		

		;; r11c5 - wall
		(not (is-clear r11c5))
		(move-dir r11c5 r10c5 up)
		(move-dir r11c5 r11c4 left)
		(move-dir r11c5 r11c6 right)
		

		;; r11c6 - wall
		(not (is-clear r11c6))
		(move-dir r11c6 r10c6 up)
		(move-dir r11c6 r11c5 left)
