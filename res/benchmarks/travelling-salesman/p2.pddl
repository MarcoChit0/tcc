(define (problem p2-travelling-salesman)
	...
	(:init
		...
		(selling-price spongebob-squarepants-magical-pencil 3 p1)
		(person-at p1 b)
		(is-buyer p2)
		(stock spongebob-squarepants-magical-pencil 0 p2)
		(buying-price spongebob-squarepants-magical-pencil 4 p2)
		(person-at p2 b)
